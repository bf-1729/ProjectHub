...
const Projects = () => {
  ...
  const filteredProjects = (projects || []).filter((project) => {
    ...
    if (role === "supervisor") {
      ...
      if (Array.isArray(project.supervisors)) {
        ...
        return project.supervisors === userId;
      }
    }
  ...
  const handleCreateProject = async (e) => {
    e.preventDefault();
    if (!formData.projectName || !formData.projectStatus || !formData.supervisors) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-100 px-8 pb-12 mt-26 w-full">
                ...
                <div className="relative z-10 flex flex-col h-full">
                  <div className="flex justify-between items-center -mt-4">
                    <div className="flex items-center justify-between w-full">
                      <div className="text-lg font-semibold text-gray-800 flex items-center -mt-6">
  ...
  {onHoldProjects.length ? (
    ...
    <p className="text-gray-500 italic mt-4">No projects on hold.</p>
      ...
      {imageModal.open && (
        ...
        >
          <div
            className="relative bg-white rounded-xl shadow-lg max-w-4xl w-1/2 max-h-[90vh] overflow-auto p-6"
